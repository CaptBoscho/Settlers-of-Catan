 ...
 */
public class SetupOneState extends TurnTrackerControllerState {
     ...
     * Constructor
     */
    public SetupOneState(ITurnTrackerView view){
        super(view);
        this.view = view;
    ...
    public void initFromModel() {
        ...
        //Game State
        if(facade.getCurrentTurn() == facade.getLocalPlayerIndex()){
            view.updateGameState("Setup 1 - end placement", true);
        }else{
