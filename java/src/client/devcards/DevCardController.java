...
public final class DevCardController extends Controller implements IDevCardController, Observer {
	...
	public void playMonopolyCard(ResourceType resource) {
		Facade.getInstance().playMonopolyCard(UserCookie.getInstance().getPlayerInfo().getPlayerIndex(),resource);
	}

	@Override
	public void playMonumentCard() {
		Facade.getInstance().playMonumentCard(UserCookie.getInstance().getPlayerInfo().getPlayerIndex());
	}
	...
	public void playYearOfPlentyCard(ResourceType resource1, ResourceType resource2) {
		Facade.getInstance().playYearOfPlentyCard(UserCookie.getInstance().getPlayerInfo().getPlayerIndex(), resource1, resource2);
	}
}
