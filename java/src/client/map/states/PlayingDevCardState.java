 ...
 *
 * Represents Playing Development Card State - Base class for specific Dev Cards
 */
public class PlayingDevCardState extends MapControllerState {
    private Game gModel;

    /**
     * Constructor
     */
    public PlayingDevCardState(){
